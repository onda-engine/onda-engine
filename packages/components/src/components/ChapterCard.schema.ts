...
export const chapterCardSchema = z.object({
  ...
  delay: timeSchema
    .default(0)
    .describe('Frames before the number starts fading in; the whole card sequences off this.'),
  accent: z
    .boolean()
    .default(true)
    .describe(
  ...
  numberFontSize: z
    .number()
    .default(32)
    .describe('Number font size in px \u2014 smaller than the title, sitting above it.'),
