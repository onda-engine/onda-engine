...
export const statCardSchema = z.object({
  value: z.string().describe("The headline metric, e.g. \"26.8 fps\" or \"100\u00d7\" (a number is stringified)."),
  label: z.string().describe("The label beneath the value, e.g. \"faster than Remotion\"."),
  ...
  accent: z.any().default(true).describe("Show the accent rule beneath the value: true/undefined shows it (theme accent), false hides it, a string shows it in that color."),
