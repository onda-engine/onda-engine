...
export const codeBlockSchema = z.object({
  ...
  fontFamily: z.string().describe("Monospace font stack; code needs column alignment (defaults to theme monoFamily)."),
  ...
  textColor: z.string().describe("Default text color for identifiers, punctuation, operators (defaults to theme text)."),
  keywordColor: z.string().describe("Keyword color \u2014 a muted, dusty violet (defaults to theme palette[1])."),
  stringColor: z.string().describe("String literal color \u2014 dusty sage (defaults to theme palette[3])."),
  commentColor: z.string().describe("Comment color (defaults to theme textMuted)."),
  numberColor: z.string().describe("Numeric literal color \u2014 dusty amber (defaults to theme palette[2])."),
  tagColor: z.string().describe("JSX / HTML tag-name color \u2014 dusty cyan (defaults to theme palette[1])."),
  panelColor: z.string().describe("Panel background fill \u2014 the glass surface (defaults to theme surface)."),
  borderColor: z.string().describe("Panel border color (defaults to theme border)."),
})
