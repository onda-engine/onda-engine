...
export const codeBlockSchema = z.object({
  ...
  textColor: z.string().optional().describe("Default text color for identifiers, punctuation, operators (defaults to theme text)."),
  keywordColor: z.string().optional().describe("Keyword color \u2014 a muted, dusty violet (defaults to theme palette[1])."),
  stringColor: z.string().optional().describe("String literal color \u2014 dusty sage (defaults to theme palette[3])."),
  commentColor: z.string().optional().describe("Comment color (defaults to theme textMuted)."),
  numberColor: z.string().optional().describe("Numeric literal color \u2014 dusty amber (defaults to theme palette[2])."),
  tagColor: z.string().optional().describe("JSX / HTML tag-name color \u2014 dusty cyan (defaults to theme palette[1])."),
  panelColor: z.string().optional().describe("Panel background fill \u2014 the glass surface (defaults to theme surface)."),
