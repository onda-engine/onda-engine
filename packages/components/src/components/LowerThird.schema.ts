...
export const lowerThirdSchema = z.object({
  ...
  placement: z
    .enum(['bottom-left', 'bottom-right', 'bottom-center', 'top-left', 'top-right', 'top-center'])
    .default('bottom-left')
    .describe(
      'Which canvas region the bar sits in; corners flush left/right, *-center centers the block on the mid-line (for a single credit/URL line).',
    ),
