...
export const spotlightCardSchema = z.object({
  ...
  fontFamily: z.string().optional().describe("Display font for the title (default: theme headingFamily ?? theme.fontFamily)."),
  bodyFontFamily: z.string().optional().describe("Font family for the eyebrow and body copy (default: theme fontFamily)."),
  ...
  background: z.string().optional().describe("Card glass fill, translucent dark by default (default: theme surface)."),
  borderColor: z.string().optional().describe("Card border (stroke) color (default: theme border)."),
