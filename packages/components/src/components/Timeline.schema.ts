...
export const timelineSchema = z.object({
  ...
  accentColor: z.string().optional().describe("Final dot color \u2014 the earned accent (default: theme accent)."),
  ...
  fontFamily: z.string().optional().describe("Loaded font family for labels (default: theme headingFamily ?? fontFamily)."),
})
