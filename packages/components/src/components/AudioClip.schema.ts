...
export const audioClipSchema = z.object({
  ...
  startAt: z.any().default(0).describe("Where to start in the source audio. Time spec \u2014 \"0:04\", \"30s\", \"500ms\", \"90f\", or a raw number of seconds."),
  endAt: z.any().optional().describe("Where to stop in the source (same time spec as startAt). When omitted, plays to the source's end; required for loop."),
  ...
  acceptableTimeShiftSeconds: z.number().optional().describe("Acceptable time-shift threshold before resync (seconds)."),
})
