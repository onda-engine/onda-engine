...
export const calloutSchema = z.object({
  ...
  x: z
    .number()
    .default(0.5)
    .describe('Bubble-center X as a 0..1 fraction of canvas width (default 0.5 = center).'),
  y: z
    .number()
    .default(0.5)
    .describe('Bubble-center Y as a 0..1 fraction of canvas height (default 0.5 = center).'),
  direction: z
  ...
  pointerLength: z
    .number()
    .default(12)
    .describe('Pointer triangle length (how far it pokes out) in px.'),
  width: z
    .number()
    .optional()
    .describe('Explicit bubble width in px. Overrides the measured text extent.'),
