...
export const quoteCardSchema = z.object({
  quote: z
    ...
    .describe('The pull-quote body, revealed word-by-word on a slower-than-canonical stagger.'),
  ...
  accent: z
    .boolean()
    .default(true)
    .describe('Show the accent divider between quote and attribution.'),
  ...
  quoteWidth: z
    .number()
    .optional()
    .describe('Wrap width for the quote in px (defaults to ~44% of the composition width).'),
