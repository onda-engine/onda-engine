...
export const dynamicGridSchema = z.object({
  ...
  color: z.string().describe("Grid color (hex #rrggbb / #rrggbbaa); defaults to theme border."),
  ...
  glowColor: z.string().describe("Glow color (hex); the meaningful color on the CPU fallback (first stop); defaults to theme accent."),
  background: z.string().describe("Canvas color painted behind the grid; defaults to theme background."),
