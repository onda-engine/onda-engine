...
export const kanbanBoardSchema = z.object({
  ...
  delay: z.number().int().default(0).describe("Frames before the first card enters."),
  stagger: z.number().int().optional().describe("Frames between successive cards rising in (house stagger = 4)."),
