...
export const confettiSchema = z.object({
  ...
  delay: z.number().int().default(0).describe("Frames before the burst launches."),
  duration: z.number().int().default(70).describe("Frames over which a piece travels, tumbles and fades out."),
