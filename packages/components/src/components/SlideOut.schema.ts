...
export const slideOutSchema = z.object({
  delay: z.number().int().default(0).describe("Frames before the exit animation starts."),
  durationInFrames: z.number().int().optional().describe("Frames to fully leave; exits are quicker than entrances."),
