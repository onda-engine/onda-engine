...
export const pricingCardSchema = z.object({
  ...
  price: z.string().default('$29').describe("The headline price, rendered large. Free-form: '$29', '\u20ac19', 'Free'."),
  period: z.string().default('/month').describe("Billing period beneath the price (e.g. '/month'). Empty hides it."),
  features: z.array(z.string()).optional().describe("Feature checklist \u2014 each item gets an accent checkmark, revealed on a stagger."),
  ...
  borderColor: z.string().optional().describe("Panel border color (when not recommended) (default: theme border)."),
  color: z.string().optional().describe("Primary text color (price, features) (default: theme text)."),
  dimColor: z.string().optional().describe("Dim color for the tier label (default: theme textMuted)."),
  faintColor: z.string().optional().describe("Faint color for the billing period (default: theme textMuted)."),
  fontFamily: z.string().optional().describe("Display font for the price (default: theme headingFamily ?? fontFamily)."),
