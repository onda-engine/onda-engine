...
export const underlineSchema = z.object({
  text: z
    ...
    .describe('Text to reveal. Pass "" to draw the rule alone.'),
  ...
  lineDelay: timeSchema
    .default(8)
    .describe('Frames to wait after the text lands before the rule starts drawing.'),
  ...
  align: z
    ...
    .default('left')
    .describe('Horizontal alignment of the rule under the text.'),
})
