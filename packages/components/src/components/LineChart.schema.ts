...
export const lineChartSchema = z.object({
  data: z
    ...
    .describe('The series values, left to right.'),
  ...
  color: z
    .string()
    .optional()
    .describe('Line + dot color \u2014 the earned accent (defaults to theme accent).'),
  ...
  showDots: z
    .boolean()
    .default(true)
    .describe('Show a dot at each data point as the line reaches it.'),
})
