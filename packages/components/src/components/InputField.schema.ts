...
export const inputFieldSchema = z.object({
  ...
  value: z
    ...
    .describe("The field's value; with `typed` on, this is what types itself in."),
  placeholder: z
    .string()
    .default('Enter your email')
    .describe('Placeholder shown while the field is empty, before any glyph is revealed.'),
  label: z.string().default('Email').describe('Label above the field; an empty string hides it.'),
  typed: z
    .boolean()
    .default(true)
    .describe('Animate `value` typing itself in character-by-character via useTextReveal.'),
  ...
  focusRing: z
    .boolean()
    .default(true)
    .describe('Show the accent focus ring around the field once typing begins.'),
  width: z
    .number()
    .default(640)
  ...
  placeholderColor: z
    .string()
    .optional()
    .describe('Placeholder text color; defaults to the theme `textMuted`.'),
  labelColor: z
    .string()
    .optional()
    .describe('Label text color; defaults to the theme `textMuted`.'),
  accentColor: z
    .string()
    .optional()
    .describe('Caret and focus-ring color, the one earned accent; defaults to the theme `accent`.'),
  borderColor: z
    .string()
    .optional()
    .describe('Resting (unfocused) field border color; defaults to the theme `border`.'),
  fieldColor: z
    .string()
    .optional()
    .describe('Field background fill, the glass surface; defaults to the theme `surface`.'),
  x: z
    .number()
    .default(0.5)
    .describe('Horizontal center of the field as a 0\u20131 fraction of canvas width.'),
  y: z
    .number()
    .default(0.5)
    .describe('Vertical center of the field as a 0\u20131 fraction of canvas height.'),
