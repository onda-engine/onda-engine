...
const SIZE = 290, SANS = 'IBM Plex Sans', WEIGHT = 400, BG = '#ECECEC'
...
function Debug({ width, height }) {
  return h(Group, null,
    ...
    h(Text, { x: startX, y: cyText, fontSize: SIZE, fontFamily: SANS, fontWeight: WEIGHT, color: '#E8732B' }, 'test 3 colo'),
    h(Rect, { x: cursorX + 2, y: cyText + FM.capTop, width: 10, height: FM.capHeight, fill: '#F08030' }),
...
export default function({ fps, durationInFrames, width, height }) {
  return h(Composition, { width, height, fps, durationInFrames, linear: true }, h(Debug, { width, height }))
}
