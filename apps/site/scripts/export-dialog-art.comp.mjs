...
import { Composition, Ellipse, Group, Image, Rect, linearGradient, renderFrame } from '@onda/react'
...
const scene = h(
  ...
  h(Rect, {
    width: W,
    height: H,
    gradient: linearGradient([0, 0], [0, H], [
  ...
  h(Group, { blur: 90 }, h(Ellipse, { x: -180, y: 240, width: 900, height: 460, fill: '#4c1d95', opacity: 0.85 })),
  h(Group, { blur: 70 }, h(Ellipse, { x: 320, y: 420, width: 820, height: 380, fill: '#7c3aed', opacity: 0.7 })),
  h(Group, { blur: 60 }, h(Ellipse, { x: 120, y: 560, width: 560, height: 240, fill: '#a78bfa', opacity: 0.45 })),
  // A thin bright crest line where the wave breaks — the "horizon glow".
  h(Group, { blur: 18 }, h(Rect, { x: -60, y: 700, width: W + 120, height: 10, fill: '#c4b5fd', opacity: 0.55, rotation: -7 })),
  // Faint second crest, lower and dimmer — depth.
  h(Group, { blur: 26 }, h(Rect, { x: -60, y: 960, width: W + 120, height: 8, fill: '#7c3aed', opacity: 0.3, rotation: -4 })),
...
const comp = h(
  Composition,
  {
    ...
    finish: { bloom: { sigma: 22, threshold: 0.32, intensity: 1.6 }, halation: 0.35, vignette: 0.28 },
  },
  scene,
)
